...
const messages = {
  en: {
    ...
    demo: 'Preview mode · no public profiles yet · submissions are not stored',
    ...
    demoSubmit: 'Preview submission', liveSubmit: 'Submit for moderation', pending: 'Submitted for moderation. It is not public unless approved.',
    ...
    profileUrl: 'Official university profile URL', researchAreas: 'Research areas (comma separated)', sendRequest: 'Preview request', sendRequestLive: 'Submit request', requestPending: 'Faculty request submitted for moderation.',
    ...
    noResults: 'No faculty match these filters.', emptyLeaderboard: 'No approved faculty profiles yet.',
    requestFirstFaculty: 'Request the first faculty profile', reviewNeedsFaculty: 'A faculty profile must be approved before reviews can be submitted.',
    emptyModeration: 'No pending moderation items.', back: 'Back to leaderboard', language: '中文',
    scoreHint: '0 extremely negative · 5 mixed · 10 extremely positive', reportReview: 'Report review',
    reportReason: 'Reason', reportDetails: 'Details', cancel: 'Cancel', sendReport: 'Preview report', sendReportLive: 'Submit report', reportPending: 'Report submitted for moderation.',
  },
  zh: {
    subtitle: '北美机器人方向博士生导师的社区经验指南',
    demo: '预览模式 · 暂无公开教师档案 · 投稿不会被保存',
    ...
    demoSubmit: '预览投稿', liveSubmit: '提交审核', pending: '已提交审核；只有审核通过后才会公开。',
    ...
    profileUrl: '学校官方主页链接', researchAreas: '研究方向（用逗号分隔）', sendRequest: '预览申请', sendRequestLive: '提交申请', requestPending: '教师档案申请已提交审核。',
    ...
    noResults: '没有符合当前筛选条件的教师。', emptyLeaderboard: '暂无已审核通过的教师档案。',
    requestFirstFaculty: '申请新增第一位教师', reviewNeedsFaculty: '教师档案审核通过后才能提交评论。',
    emptyModeration: '暂无待审核内容。', back: '返回排行榜', language: 'English',
    scoreHint: '0 极度负面 · 5 中立或复杂 · 10 极度正面', reportReview: '举报评论',
    reportReason: '举报原因', reportDetails: '详细说明', cancel: '取消', sendReport: '预览举报', sendReportLive: '提交举报', reportPending: '举报已提交审核。',
  },
} as const
